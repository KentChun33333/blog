...
from advance_grid_word import GridWord as Maze
...
def run_maze():
    ...
    for episode in range(36000):
        ...
        while True:        
            ...
            # 
            if (step > 2000 and env.ratio > 0.4) and env.many_ternimal==True:
              # fixed action and not going to learn
              env.epsilon = 1.
              pass 
            elif step>200 and step % 3 ==0:
              RL.learn()
